...
go
Insert into LoginErrorLog(ErrorLogID,ErrorTime,FailedTransactionXML)
values (616,'01-Oct-2021 14:15:12.023','LEL-616-01OCT21'),
(617,'04-Oct-2021 07:00:00.45','LEL-617-04OCT21')
...
/*9.	Create a stored procedure that takes a deposit as a parameter and updates CurrentBalance value 
for that particular account. [Advanced]*/
